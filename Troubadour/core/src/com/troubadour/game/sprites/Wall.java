...
public class Wall {
    ...
    public Wall(float y){
        ...
        boundsRight = new Rectangle(posRightWall.x, posRightWall.y, WALL_LENGTH , WALL_THICK/4 );
        boundsLeft = new Rectangle(posLeftWall.x, posLeftWall.y, WALL_LENGTH , WALL_THICK /4);
    }
